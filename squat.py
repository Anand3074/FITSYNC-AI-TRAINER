...
def angles(lmlist,p1,p2,p3,p4,p5,p6,drawpoints):
    ...
    if len(lmlist)!= 0:
        ...
        if drawpoints == True:
            ...
            # print(lefthandangle)
            lefthandangle = np.interp(lefthandangle, [85, 173], [100, 0])
            ...
            cv2.putText(img, percentage_str, (350, 50),
...
while 1:
    ...
    angles(lmlist,24,26,28, 23,25, 27, drawpoints=1)
    # print(lmlist[13])
    # point = lmlist[14]
